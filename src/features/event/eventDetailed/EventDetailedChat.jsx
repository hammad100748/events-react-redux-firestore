...
class EventDetailedChat extends Component {
  ...
  handleOpenReplyForm = id => () => {
    this.setState({
      showReplyForm: true,
      selectedCommentId: id //check for opening specific comment reply
    });
  };
                        ...
                        {showReplyForm &&
                          selectedCommentId === comment.id && (
                            <EventDetailedChatForm
                              ...
                              eventId={eventId}
                              form={`reply_${comment.id}`} //specify which for we are targeting
                            ...
                            {showReplyForm &&
                              selectedCommentId === child.id && (
                                <EventDetailedChatForm
                                  addEventComment={addEventComment}
                                  eventId={eventId}
                                  form={`reply_${child.id}`} //specify which for we are targeting
                                  closeForm={this.handleCloseReplyForm}
